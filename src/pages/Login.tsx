      ...
      <div className="w-full max-w-md animate-scale-in">
        ...
        <div className="text-center mb-2 lg:mb-3">
          <div className="flex justify-center mb-0 lg:mb-0">
            <img src="/grabdeal-logo.png" alt="GrabDeal" className="h-48 lg:h-48 w-auto" />
          </div>
          <p className="text-sm lg:text-base text-white/70">Powered By D-Code Studio</p>
        </div>
        ...
        <p className="text-center text-white/50 text-xs lg:text-sm mt-4 lg:mt-6">
          © 2026 Grab lead. All rights reserved by D-Code Studio.
        </p>
      </div>
    </div>
  )
